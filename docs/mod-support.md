...
| Tweaks Anthology v18 | 270 stable IDs mapped against 446 live TP2 declarations; installer-declared alternatives and selected EEex prerequisites are guarded | Yes for mapped source selectors | **Untested** — starter and Forge install receipts exist, but policy launch smoke and 176 structural entries still need user-intent classification | [registry](../registry/packages/tweaks-anthology.yaml) |
