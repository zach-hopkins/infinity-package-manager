...
| The Longer Road v2.0.7 | Complete two-component catalog; main requires two exact Ascension choices, optional portrait requires main | Executable BG2EE/EET main route mapped; clean build pending | **Untested** — no Longer Road build, launch, or gameplay evidence yet | [registry](../registry/packages/longerroad.yaml) |
