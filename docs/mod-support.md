...
| Sword Coast Stratagems v35.21 | Initial named selector subset; full catalog expansion is in progress | Yes for the mapped selectors | Batch dispatcher plus 2000/5900/6030/6040 verified; all other selections unverified | [registry](../registry/packages/stratagems.yaml) |
