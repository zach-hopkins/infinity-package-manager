...
| Crossmod Banter Pack v30 | Complete three-component catalog; actual content depends on already-installed covered NPC mods | Exact source route resolves executable after mapped Isra BG2 partner | **Untested** pending disposable install and two-partner content test | [registry](../registry/packages/crossmod-banter-pack.yaml) |
