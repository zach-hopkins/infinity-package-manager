...
| BioWare NPC Flirt Packs v1.07 | Complete 16-component structural catalog: four companions, SoA/ToB, with separate Solaufein interaction choices | Executable source-tag route for BG2EE/EET; eight base English choices selected in a clean fixture | **Untested** — no managed build or launch evidence yet | [registry](../registry/packages/npcflirt.yaml) |
...
selected and 80 indexed candidates. Twenty-five of those candidates (Sirene,
...
Quality Soundclips, Banter Pack, and BioWare NPC Flirt Packs) now have curated executable identities; 55 remain
