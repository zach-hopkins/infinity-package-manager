...
| Tweaks Anthology v18 | 155 stable IDs mapped against 446 live TP2 declarations; Forge selections plus visual/UI, gameplay, and spell-progression groups are named, with installer-declared alternatives guarded | Yes for mapped source selectors | **Untested** — starter and Forge install receipts exist, but policy launch smoke and 291 structural entries still need user-intent classification | [registry](../registry/packages/tweaks-anthology.yaml) |
