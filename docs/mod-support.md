...
| Ajantis BG1 Expansion v22 | Complete three-component catalog: main, optional shield art, optional SoD NPC crossmod content | Executable BGEE main-component fixture now includes DLC Merger for this unmerged-SoD source | **Untested** — initial attempt hit the documented SoD prerequisite; clean retry and launch pending, optional components Untested | [evidence](pa4-bgee-ajantis-bg1-expansion-evidence.md) |
