...
| Cernd Friendship v1.4 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/cernd-friendship.yaml) |
| Haer'dalis Friendship v1.2 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/haerdalis-friendship.yaml) |
| Imoen Friendship v3.6 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/imoen-friendship.yaml) |
| Korgan Friendship v1.6 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/korgan-friendship.yaml) |
| Mazzy Friendship v3.5 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/mazzy-friendship.yaml) |
| Minsc Friendship v1.3 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/minsc-friendship.yaml) |
| Sarevok Friendship v2.7 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/sarevok-friendship.yaml) |
| Valygar Friendship v1.5 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/valygar-friendship.yaml) |
| Viconia Friendship v4.5 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/viconia-friendship.yaml) |
| Yoshimo Friendship v5.0 | Complete one-component catalog | Default BG2EE route resolves as executable | **Untested** — no install or launch receipt | [registry](../registry/packages/yoshimo-friendship.yaml) |
