...
| Drake v1.7a | Complete six-component structural catalog, including one required portrait choice | BGEE NPC and default portrait installed and sealed; launch exited before menu | **Untested** — install-only evidence, launch cause unresolved; release tag v1.7a and TP2 VERSION 1.7 are distinct | [evidence](pa4-bgee-drake-evidence.md) |
