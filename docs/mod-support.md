...
| Turnabout v1.8 | Complete two-component catalog; main requires Ascension's rewritten final chapter, while optional portrait is independent | Executable BG2EE/EET route structurally mapped; clean build pending | **Untested** — no Turnabout build, launch, or gameplay evidence yet | [registry](../registry/packages/turnabout.yaml) |
