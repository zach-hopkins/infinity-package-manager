...
| Generalized Biffing v2.9 | Complete two-choice subcomponent catalog; final-phase placement reflects author's after-all-mods direction | Executable BGEE/BG2EE/EET route mapped; bounded BG2EE build pending | **Untested** — final-stage behavior and game launch not yet checked | [registry](../registry/packages/generalized-biffing.yaml) |
