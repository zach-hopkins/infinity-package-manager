...
| Tweaks Anthology v18 | 55 stable IDs mapped against 450 locally observed TP2 declarations; Forge selections and the first visual/UI group are named | Yes for mapped source selectors | **Untested** — starter and Forge install receipts exist, but policy launch smoke and 395 structural entries still need user-intent classification | [registry](../registry/packages/tweaks-anthology.yaml) |
