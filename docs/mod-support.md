...
| Dorn Friendship 1.2 | Complete one-component catalog, two languages | BG2EE default built and launched; revision-pinned receipt pending | **Untested** until durable evidence is pinned; EET Untested | [registry](../registry/packages/dorn-friendship.yaml) |
| Hexxat Friendship 1.2 | Complete one-component catalog, two languages | BG2EE default built and launched; revision-pinned receipt pending | **Untested** until durable evidence is pinned; EET Untested | [registry](../registry/packages/hexxat-friendship.yaml) |
| Jaheira Friendship v1.3 | Complete one-component catalog, two languages | BG2EE default built and launched; revision-pinned receipt pending | **Untested** until durable evidence is pinned; EET Untested | [registry](../registry/packages/jaheira-friendship.yaml) |
| Korgan's Redemption v10.0.1 | Complete one-component catalog, five languages | BG2EE default built and launched; revision-pinned receipt pending | **Untested** until durable evidence is pinned; EET Untested | [registry](../registry/packages/korgans-redemption.yaml) |
