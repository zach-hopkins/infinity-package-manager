...
| Tweaks Anthology v18 | 114 stable IDs mapped against 450 locally observed TP2 declarations; Forge selections plus visual/UI and gameplay-rule groups are named, with installer-declared alternatives guarded | Yes for mapped source selectors | **Untested** — starter and Forge install receipts exist, but policy launch smoke and 336 structural entries still need user-intent classification | [registry](../registry/packages/tweaks-anthology.yaml) |
