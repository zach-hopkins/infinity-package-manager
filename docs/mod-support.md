...
| Brage's Redemption v10.1 | Exact official tag and four labeled selectors; BGEE/EET main requires BGQE Brage's Sword, unlike BG2EE | All four selectors installed and sealed after BGQE prerequisite on SoD-enabled BGEE | **Untested** pending observed menu/gameplay and BG2EE/EET routes; BG2 content incomplete per author | [install evidence](pa4-bgee-brage-evidence.md) |
