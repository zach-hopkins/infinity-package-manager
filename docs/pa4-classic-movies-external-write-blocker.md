...
All eight selectors now have a registry record. The independent chapter/dream
screen choice has a clean [disposable BGEE receipt](pa4-bgee-classic-movies-safe-evidence.md),
but the seven movie-related choices below remain unavailable.
...
We did not run any of those seven choices merely to see whether the external
write would occur.

Before enabling those choices, isolate WeiDU's user directory into a per-build sandbox
...
exact ZIP and all eight selectors are indexed, but the safe chapter/dream
screen install does not verify movie restoration.
