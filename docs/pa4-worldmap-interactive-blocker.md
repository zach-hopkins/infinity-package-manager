...
Its TP2 declares six LABEL-bearing selectors. This is a mechanical catalog,
not an executable IEPM release record yet.
...
the six numbered selectors would make lockfile preflight claim executable
while leaving this package unable to complete unattended. We therefore have
not promoted Worldmap from discovery-only or attempted a disposable build.

Before promotion, IEPM needs a small, explicit way to supply validated
